...
def create_threshold_image(rgb_array: np.ndarray, output_path: str, threshold: Tuple[int, int, int] = (125, 125, 125)) -> bool:
    """
...
if __name__ == "__main__":
    ...
    rgb_txt_path = "/tmp/rgb_values.txt"  # Where to save the RGB values text file
    threshold_image_path = sys.argv[1]+"contour_image.png"  # Where to save the threshold image
